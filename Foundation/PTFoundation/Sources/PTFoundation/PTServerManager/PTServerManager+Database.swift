...
internal enum PTServerManagerDatabaseTypes {
    ...
    static let id = SQLite.Expression<String>("record_identity")
    static let server = SQLite.Expression<String>("server_identity")
    static let timestamp = SQLite.Expression<Double>("record_timestamp_since1970")
    static let status = SQLite.Expression<String>("status_json")
}
